  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        to: "/postlogin/designation_master",
        activeArr: ["/postlogin/designation_master"],
        open: false,
      },
      {
        _tag: "SidebarNavItem",
        name: "Employee Master",
        to: "/postlogin/employee_master",
        activeArr: ["/postlogin/employee_master"],
        open: false,
      },
      {
        _tag: "SidebarNavItem",
        name: "Role Master",
        to: "/postlogin/role_master",
        activeArr: ["/postlogin/role_master"],
        open: false,
      },
      {
        _tag: "SidebarNavItem",
        name: "User Master",
        to: "/postlogin/user_master",
        activeArr: ["/postlogin/user_master"],
        open: false,
      },
      {
        _tag: "SidebarNavItem",
        name: "Setting Master",
        to: "/postlogin/setting_master",
        activeArr: ["/postlogin/setting_master"],
        open: false,
      },
    ],
  },
